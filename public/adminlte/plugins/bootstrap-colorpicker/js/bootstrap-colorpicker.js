...
var SliderHandler = function () {
  ...
  /**
   * This function is called every time a slider_back guide is moved
  ...
  _createClass(SliderHandler, [{
    ...
    value: function pressed(e) {
      ...
      // detect the slider_back and set the limits and callbacks
      ...
      for (var sliderName in sliders) {
        ...
        if (zone.is(slider.selector)) {
          ...
          this.currentSlider = _jquery2.default.extend({}, slider, { name: sliderName });
          zone = zone.parent(); // zone.parents(slider_back.selector).first() ?
          break;
        }
      }
